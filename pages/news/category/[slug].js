                ...
                <div className={styles.timgTop}>
                  ...
                  <div className={styles.right}>
                    ...
                    <div className={styles.twitter}>
                      <a target="_blank" rel="noreferrer" href={post.data && "https://twitter.com/intent/tweet?text=" + post.data[0].attributes.Title + "&url=" + encodedUrl} data-bs-toggle="tooltip" data-bs-placement="top" title='Share on Twitter'>
