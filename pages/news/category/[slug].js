                ...
                <div className={styles.timgTop}>
                  ...
                  <div className={styles.right}>
                    ...
                    <div className={styles.twitter}>
                      <a target="_blank" rel="noreferrer" href={post.data && "https://twitter.com/intent/tweet?text=" + title.split('|').join("") + "&url=" + encodedUrl} data-bs-toggle="tooltip" data-bs-placement="top" title='Share on Twitter'>
